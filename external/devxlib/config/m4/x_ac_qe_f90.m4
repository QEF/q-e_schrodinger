...
*:*gfortran )
        ...
        try_fflags_linelen="-ffree-line-length-512"
...
if test "$fflags_linelen" = ""  ; then fflags_linelen=$try_fflags_linelen     ; fi
...
echo setting FFLAGS_LINELEN... $fflags_linelen

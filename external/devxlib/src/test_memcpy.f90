...
!
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__sp_r1d, A_hst1__sp_r1d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__sp_r1d, A_dev2__sp_r1d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__sp_r1d, A_hst2__sp_r1d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__sp_r2d, A_hst1__sp_r2d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__sp_r2d, A_dev2__sp_r2d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__sp_r2d, A_hst2__sp_r2d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__sp_r3d, A_hst1__sp_r3d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__sp_r3d, A_dev2__sp_r3d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__sp_r3d, A_hst2__sp_r3d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__sp_r4d, A_hst1__sp_r4d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__sp_r4d, A_dev2__sp_r4d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__sp_r4d, A_hst2__sp_r4d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__dp_r1d, A_hst1__dp_r1d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__dp_r1d, A_dev2__dp_r1d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__dp_r1d, A_hst2__dp_r1d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__dp_r2d, A_hst1__dp_r2d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__dp_r2d, A_dev2__dp_r2d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__dp_r2d, A_hst2__dp_r2d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__dp_r3d, A_hst1__dp_r3d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__dp_r3d, A_dev2__dp_r3d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__dp_r3d, A_hst2__dp_r3d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__dp_r4d, A_hst1__dp_r4d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__dp_r4d, A_dev2__dp_r4d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__dp_r4d, A_hst2__dp_r4d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__sp_c1d, A_hst1__sp_c1d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__sp_c1d, A_dev2__sp_c1d)
  !
  ! retrieve conjg data
  call dev_conjg( A_hst2__sp_c1d )
  
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__sp_c1d, A_hst2__sp_c1d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__sp_c2d, A_hst1__sp_c2d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__sp_c2d, A_dev2__sp_c2d)
  !
  ! retrieve conjg data
  call dev_conjg( A_hst2__sp_c2d )
  
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__sp_c2d, A_hst2__sp_c2d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__sp_c3d, A_hst1__sp_c3d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__sp_c3d, A_dev2__sp_c3d)
  !
  ! retrieve conjg data
  call dev_conjg( A_hst2__sp_c3d )
  
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__sp_c3d, A_hst2__sp_c3d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__sp_c4d, A_hst1__sp_c4d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__sp_c4d, A_dev2__sp_c4d)
  !
  ! retrieve conjg data
  call dev_conjg( A_hst2__sp_c4d )
  
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__sp_c4d, A_hst2__sp_c4d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__dp_c1d, A_hst1__dp_c1d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__dp_c1d, A_dev2__dp_c1d)
  !
  ! retrieve conjg data
  call dev_conjg( A_hst2__dp_c1d )
  
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__dp_c1d, A_hst2__dp_c1d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__dp_c2d, A_hst1__dp_c2d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__dp_c2d, A_dev2__dp_c2d)
  !
  ! retrieve conjg data
  call dev_conjg( A_hst2__dp_c2d )
  
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__dp_c2d, A_hst2__dp_c2d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__dp_c3d, A_hst1__dp_c3d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__dp_c3d, A_dev2__dp_c3d)
  !
  ! retrieve conjg data
  call dev_conjg( A_hst2__dp_c3d )
  
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__dp_c3d, A_hst2__dp_c3d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__dp_c4d, A_hst1__dp_c4d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__dp_c4d, A_dev2__dp_c4d)
  !
  ! retrieve conjg data
  call dev_conjg( A_hst2__dp_c4d )
  
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__dp_c4d, A_hst2__dp_c4d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__i4_i1d, A_hst1__i4_i1d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__i4_i1d, A_dev2__i4_i1d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__i4_i1d, A_hst2__i4_i1d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__i4_i2d, A_hst1__i4_i2d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__i4_i2d, A_dev2__i4_i2d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__i4_i2d, A_hst2__i4_i2d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__i4_i3d, A_hst1__i4_i3d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__i4_i3d, A_dev2__i4_i3d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__i4_i3d, A_hst2__i4_i3d)
  !
  ! check
  ...
  !
  ! mem copy h2d
  call dev_memcpy(A_dev1__i4_i4d, A_hst1__i4_i4d)
  !
  ! mem copy
  ...
  !
  ! mem copy d2h
  call dev_memcpy(A_hst2__i4_i4d, A_dev2__i4_i4d)
  !
  !
  ! mem copy h2h
  call dev_memcpy(A_hst3__i4_i4d, A_hst2__i4_i4d)
  !
  ! check
